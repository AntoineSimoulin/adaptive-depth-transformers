...
def model_fn_builder(albert_config, init_checkpoint, learning_rate,
                     ...
                     start_warmup_step, num_accumulation_steps):
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    n_updates = model.get_sequence_output()
    ...
    #      "sentence_order_loss": sentence_order_loss
    #      }, every_n_iter=1000)
    ...
    if init_checkpoint:
      ...
      # if FLAGS.init_from_group0init_from_group0:
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      def metric_fn(*args):
        ...
        n_updates_mean = tf.metrics.mean(n_updates)
